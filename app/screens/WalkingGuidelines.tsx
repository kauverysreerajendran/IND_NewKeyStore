...
import { View, Text, TouchableOpacity, StyleSheet, ScrollView, Image, ImageBackground, SafeAreaView, StatusBar } from "react-native";
...
const WalkingGuidelines: React.FC<WalkingProps> = ({ navigation }) => {
  ...
  const language: "english" | "tamil" = isTranslatingToTamil ? "tamil" : "english";
    ...
    <View style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.scrollContent}>
          ...
          <View style={styles.noteContainer}>
            ...
            <Text style={styles.noteText}>
              During your first week post-surgery, consider resting or taking light walks around your home!
            </Text>
          </View>
      ...
      <View style={styles.footer}>
        <TouchableOpacity style={styles.nextButton} onPress={handleNext}>
          <Text style={styles.footerButtonText}>{texts[language].next}</Text>
        </TouchableOpacity>
      </View>
    </View>
    </ImageBackground>
