...
const MyActivity: React.FC = () => {
  ...
  const [answers, setAnswers] = useState<{ selectedDate: string | null; smokerStatus: string | null; cigarettesSmoked: number | null }>({
    selectedDate: null,
    smokerStatus: null,
...
const renderQuestion = () => {
  return (
    <View style={styles.container}>
      <Text style={styles.mainTitle}>Help Us Understand Your Lifestyle Habits for Better Insights</Text>
    ...
    >
      ...
      {currentQuestionIndex === 1 && (
        <>
          ...
          {answers.smokerStatus === 'Yes' && (
            <>
              <Text style={styles.questionText}>Number of cigarettes smoked today:</Text>
              <TextInput
                style={styles.textInput}
                keyboardType="numeric"
                onChangeText={(text) => handleAnswer(parseInt(text), 'cigaretteCount')}
      ...
      {currentQuestionIndex === 3 && (
        <Text style={styles.questionText}>Thank you for your responses!</Text>
      )}
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.datePickerContainer}>
          <TouchableOpacity style={styles.optionButton} onPress={openDatePicker}>
            <Text style={styles.optionText}>
              {answers.selectedDate ? `Date: ${answers.selectedDate}` : 'Select a Date'}
            </Text>
          </TouchableOpacity>
          {datePickerVisible && (
            <Modal
